export const fakeData = {
  ...
  details: { height: { cm: 42, inches: 16 }, weight: { kg: 42, lbs: 92 } },
  techniques: [
    {
      name: 'DNA Extraction',
  ...
  locations: [
    {
      ...
      frequency: '20%',
      level: '46 - 52',
      freetem: { minLevel: 46, maxLevel: 52, minPansuns: 434, maxPansuns: 488 },
    },
  ],
  ...
  catchRate: 30,
  hatchMins: 39,
  tvYields: { hp: 0, sta: 0, spd: 0, atk: 0, def: 1, spatk: 0, spdef: 1 },
  gameDescription:
